    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Career Queries</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Career Queries</li>
                    </ol>
                </div>
            </div>
        </div>
...
">
                        ...
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    <?php
                                    $fetch_blog = mysqli_query($con, "select * from career_table order by id desc");
                                        $i = 1;
                                    while ($res_blog = mysqli_fetch_array($fetch_blog)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="uploads/resume/<?= $res_blog['resume']; ?>" 
                                                download 

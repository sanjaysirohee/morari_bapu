...
<head>
    ...
    <title>Ram Katha Samiti Login</title>
...
">
        ...
        <strong> Your Email and Password are not match..Please Try Again.!</strong>
        </div>
       <?php
       ...
       ?>
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn btn-block btn-lg btn-info btn-rounded" type="submit" name="btn_login">Log In</button>
                            </div>
                        </div>

...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    while ($guestrow = mysqli_fetch_assoc($guestquery)) {
    fputcsv($output, [
        $i++,
        $guestrow['request_id']."_".$guestrow['id'],
        '',
        $guestrow['first_name'],
        $guestrow['middle_name'],
        $guestrow['last_name'],
        '',
        '',
        '',
        ...
        '',
        '',
        $guestrow['id_proof_type'],
        $guestrow['id_proof_number'],
        '',
        '',
        '',
        $guestrow['hotel'],
